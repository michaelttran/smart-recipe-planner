...
- **Server-side caching** — identical ingredient + preference combinations are served from Supabase instead of calling Claude again
...
Sign In / Sign Up
  ↓
Discover (camera) → Ingredients (confirm) → Customize → Recipes → Recipe Detail
                                                            ↑           |
                                                      (appends new   Share /
